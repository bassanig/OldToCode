...
// NOVOS LIMITES DE TELA AJUSTADOS
...
const FloatingAccessibilityButton = () => {
  ...
  React.useEffect(() => {
    const checkVisibility = () => {
      ...
      // O botão é visível se a largura for MAIOR que 1280 OU a altura for MAIOR que 1080.
      // Ele SÓ DESAPARECE se (width <= 1280 E height <= 1080).
      const shouldBeVisible = width > MAX_WIDTH || height > MAX_HEIGHT;
