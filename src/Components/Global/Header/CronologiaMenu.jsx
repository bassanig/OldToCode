...
import fotoArquimdes from '../../../assets/fotos/conteudos/arquimedes2.png';
...
const CronologiaMenu = ({ setShowCronologia }) => {
  ...
  useOutsideClick(menuRef, () => setShowCronologia(false));
  ...
  <div className="mx-auto flex w-full max-w-6xl gap-8 px-4">
        ...
        <div className='flex flex-col relative pb-4 px-6 '>
          <div className='flex items-center justify-between pb-4'>
            <h1 className='text-xl text-vermelho pt-3 dark:text-amarelo-dark'>{t('others')}</h1>
            <button onClick={() => setShowCronologia(false)} className='cursor-pointer top-3 right-0 w-9 h-9 rounded-full border-2 dark:border-amarelo-dark border-vermelho flex items-center justify-center hover:bg-amarelo-dark trasition duration-150 dark:hover:bg-vermelho'>
