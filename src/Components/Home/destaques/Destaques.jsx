  ...
  return (
    <section className='container mt-24'>
      ...
      <div className='flex items-stretch gap-8 mt-10'>
        <NavLink to='/conteudo/silogismo' className='bg-amarelo relative overflow-hidden group'>
        ...
        <NavLink to='/conteudo/algoritmos' className='bg-amarelo relative group overflow-hidden'>
          <div className='absolute inset-0 bg-gradient-to-t from-black to-transparent z-30'></div>
        ...
        <div className='flex flex-col justify-between gap-8'>
          <NavLink to='/conteudo/calculadoras' className='flex-1 relative group overflow-hidden'>
            <div className='absolute inset-0 bg-gradient-to-t from-black to-transparent z-30'></div>
          ...
          <NavLink to='/conteudo/pascalina' className='flex-1 relative group overflow-hidden'>
            <div className='absolute inset-0 bg-gradient-to-t from-black to-transparent z-30'></div>
